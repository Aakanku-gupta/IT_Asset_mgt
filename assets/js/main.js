...
function myFunction3() {
  var dropdownContent = document.getElementById("link_dropdown1")
...
function myFunction4() {
  var dropdownContent = document.getElementById("link_dropdown2")
  if (dropdownContent.style.display === "block") {
    dropdownContent.style.display = "none";
...
function myFunction5() {
  var dropdownContent = document.getElementById("link_dropdown3")
  if (dropdownContent.style.display === "block") {
    dropdownContent.style.display = "none";
